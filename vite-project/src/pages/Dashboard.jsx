...
const Dashboard = () =>{
  ...
  const colors=["#9333ea", "#3b82f6", "#059669", "#d97706", "#db2777"]
  ...
  return(
    <div>
       <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden'>Welcome, Tanisha Mohaptra</p>
        ...
        <div className='flex gap-4'>
          <button onClick={()=> setShowCreateResume(true)} className='w-full bg-white sm:max-w-36 h-48 flex flex-col items-center
           ...
           border-slate-300 group hover:border-teal-500 hover:shadow-lg transition-all duration-300 cursor-pointer'>
            <PlusIcon className='size-11 transition-all duration-300 p-2.5
            bg-linear-to-br from-teal-300 to-teal-500 text-white rounded-full'  />
               ...
               transition-all duration-300 cursor-pointer' style={{background:`linear-gradient(135deg,${baseColor}10, ${baseColor}40)`, borderColor: baseColor + '40' }}>
                ...
                <div onClick={e=> e.stopPropagation()} className='absolute top-1 right-1 group-hover:flex items-center hidden'>
                  ...
                  <PencilIcon onClick={()=> {setEditResumeId(resume._id); setTitle
                    (resume.title)}} className="size-7 p-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors"/>
        ...
        {showCreateResume && (
          ...
          z-10 flex items-center justify-center'>
            ...
            border shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              px-4 py-2 mb-4 border border-slate-300 rounded focus:border-green-600 focus:ring-green-600 focus:outline-none' required />
        ...
        {showUploadResume && (
          ...
          z-10 flex items-center justify-center'>
            ...
            border shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              hover:bg-green-700 transition-colors flex items-center justify-center gap-2 disabled:bg-gray-400 disabled:cursor-not-allowed'>
