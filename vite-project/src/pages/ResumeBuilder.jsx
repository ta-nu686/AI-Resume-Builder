          ...
          <div className='grid lg:grid-cols-12 gap-8'>
            ...
            <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
              <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
                ...
                from-teal-500 to-teal-600 border-none transition-all duration-2000'
                ...
                <button onClick={()=> {toast.promise(saveResume,{loading:'Saving...'})}} className='bg-gradient-to-br from-teal-100 to-teal-200
                right-teal-300 text-teal-600 ring hover:ring-teal-400
                transition-all rounded-md px-4 py-2 mt-6 text-sm'>
                  Save Changes
                </button>
              </div>
            </div>
            ...
            <div className='lg:col-span-7 max-lg:mt-6'>
              <div className='relative w-full'>
                <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                  ...
                  rounded-lg ring-teal-300 hover:ring transition-colors'>
