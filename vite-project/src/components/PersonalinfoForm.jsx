        ...
        <div>
            ...
            <div className='flex items-center gap-2'>
                ...
                {typeof data.image ==='object' && (
                    <div className='flex flex-col gp-1 pl-4 text-sm'>
                        ...
                        text-gray-900 gap-3'>
                            <input type="checkbox" className='sr-only peer' onChange={()=>setRemoveBackground(prev => !prev)} checked={removeBackground}/>
                                ...
                                peer-checked:bg-teal-600 transition-colors duration-200'>
                                </div>
                ...
                return(
                    <div key={field.key} className='space-y-1 mt-5'>
                        ...
                        <input type={field.type} value={data[field.key] || ""} onChange={(e)=>handleChange(field.key,e.target.value)} className='mt-1 w-full px-3
                            py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none
